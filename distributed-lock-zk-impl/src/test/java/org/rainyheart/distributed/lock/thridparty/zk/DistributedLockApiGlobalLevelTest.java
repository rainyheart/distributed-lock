...
public class DistributedLockApiGlobalLevelTest extends EmbeddedZooKeeperServer {

    private static final Logger LOGGER = LoggerFactory.getLogger(DistributedLockApiGlobalLevelTest.class);
    ...
    private Thread newThread(long timeout) {
        Thread thread1 = new Thread(new Runnable() {
            ...
            public void run() {
                ...
                try {
                    synchronized (DistributedLockApiGlobalLevelTest.class) {
    ...
    @Test
    public void testGlobalTryLock() throws UnknownHostException, DistributedLockException {
